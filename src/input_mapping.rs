...
pub fn map_input(callbacks: &'static Callbacks, game_pad: &mut GamePad) {
	...
	game_pad.set_button_pressed(Button::LeftDPadLeft, left_analog_left_pressed || joypad_left_pressed);
	game_pad.set_button_pressed(Button::LeftDPadRight, left_analog_right_pressed || joypad_right_pressed);
	game_pad.set_button_pressed(Button::LeftDPadUp, left_analog_up_pressed || joypad_up_pressed);
	game_pad.set_button_pressed(Button::LeftDPadDown, left_analog_down_pressed || joypad_down_pressed);
